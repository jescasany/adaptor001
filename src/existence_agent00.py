...
# -*- coding: utf-8 -*-
"""
Created on Tue Mar 28 13:32:40 2017

@author: juan escasany
"""
import pdb
...
class RecursiveExistence(Existence):
    ...
    def __init__(self, primitive_interactions, environment, robot):
        """
        ...
        (int) valence)
        """
        Existence.__init__(self, primitive_interactions, environment, robot)
    ...
    def enact_primitive_interaction(self, intended_interaction):
        ...
        experiment = intended_interaction.get_experiment()
        result_label = self.environment.return_result(experiment,robot)
        result = self.addget_result(result_label)
...
class ConstructiveExistence(RecursiveExistence):
    ...
    """
    def __init__(self, primitive_interactions, environment, robot):
        RecursiveExistence.__init__(self, primitive_interactions, environment, robot)
    ...
    def enact(self, intended_interaction):
        ...
        if intended_interaction.is_primitive():
            enacted_interaction_label = self.environment.enact_primitive_interaction(intended_interaction, robot)
