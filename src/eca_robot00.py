...
class EcaRobot00():
    def __init__(self, mechanism):
        #pdb.set_trace()
        rospy.init_node("eca_robot00_tree")
        ...
        ECAROBOT00 = Sequence("ECAROBOT00")
        ...
        ECAROBOT00.add_child(START_STEP)
        ECAROBOT00.add_child(I_F_IS_VISITED)
        
        # Display the tree before beginning execution
        print bcolors.HEADER + "ECAROBOT00 Behavior Tree" + bcolors.ENDC
        print_tree(ECAROBOT00, indent=0, use_symbols=True)
        print_dot_tree(ECAROBOT00, dotfilepath='/home/juan/catkin_ws/src/adaptor001/tree.dot')
        # Run the tree
...
if __name__ == '__main__':
    ...
    tree = EcaRobot00(args.mechanism)