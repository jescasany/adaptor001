...
Now I've to write down a behavior tree with all the tasks and, then code each branch and leaf. There is two Python scripts patrol_tree.py and clean_house_tree.py to get inspiration from. Our behavior tree now
looks like this:
